...
// Source code obtained from http://www.dusbabek.org/~garyd/bayes/
...
const USE_LOGS = false; // for some strange reason, USE_LOGS = true does not work
...
// *** the doc argument is the string you use to test the data. ***
function guess(doc) {
...
// *** the doc argument is the string you use to teach the Naive Bayes classifier engine. ***
function teachAs(cls, doc) {
  var tokens = scrub(doc);
  for (var i in tokens)
